 ...
 */
    ...
    .addLabel('a')
    footer.from('.footer-logo',{
        opacity:0,
        yPercent: 30
    },'a')
    footer.from('.btn-sign-more',{
        opacity:0,
        yPercent: 30
    },'a')
    footer.from('.info-list-area.area1',{
        opacity:0,
        yPercent: 30
    },'a+=0.5')
    footer.from('.info-list-area.area2',{
        opacity:0,
        yPercent: 30
    },'a+=0.6')
    footer.from('.footer-desc-area',{
        opacity:0,
        yPercent: 30
    },'a+=0.7')
    footer.from('.footer .desc-box',{
        opacity:0,
        yPercent: 30
    },'a+=0.8')
